...
const SidePanel = () => {
  return (
    <div className={styles['side-panel']}>
      <div className='mr-3 flex items-center ml-4 justify-between'>
      ...
      <div className='relative flex size-full overflow-hidden'>
        <div className='grow'>
          <section className='h-full w-[var(--side-width)]] shrink-0 snap-center'>
            <div className='flex size-full flex-col text-sm font-medium'>
              ...
              <div className='overflow-hidden h-full relative'>收藏</div>
            </div>
          </section>
        </div>
      </div>
